...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    ArrayList<Double> latArrayList;
    ArrayList<Double> lngArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationList  = (ArrayList<Location>)args.getSerializable("data");

        for(int i =0; i<LocationList.size();i++){
            latArrayList.add(LocationList.get(i).lat);
            lngArrayList.add(LocationList.get(i).lng);
        }
    }
        ...
        if(LocationList.size()>0){
            for(int i = 0; i<LocationList.size();i++){
                mMap.addMarker(new MarkerOptions().
                        position(new LatLng(latArrayList.get(i),lngArrayList.get(i))).
                        title("Marker"));
